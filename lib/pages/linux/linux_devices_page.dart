...
class LinuxDevicesPage extends StatefulWidget {
  final String socketUrl;

  const LinuxDevicesPage({Key key, this.socketUrl}) : super(key: key);
  @override
  _LinuxDevicesPageState createState() => _LinuxDevicesPageState();
}

class _LinuxDevicesPageState extends State<LinuxDevicesPage> {
